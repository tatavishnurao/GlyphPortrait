...
def side_by_side(ref: Image.Image, rec: Image.Image) -> Image.Image:
    ...
    d.text((ref.width + 12, 12), "face study v3", font=font(18, True), fill=(245, 245, 245))
    return out
...
def render() -> None:
    ...
    final.save(OUT / "face_study_v3.png")
    side_by_side(ref_img, final).save(OUT / "face_study_v3_side_by_side.png")
    contours_vis.save(OUT / "face_study_v3_contours.png")
    anchor_overlay.save(OUT / "face_study_v3_anchor_overlay.png")
    ...
    (OUT / "face_study_v3_metrics.json").write_text(json.dumps(metrics, indent=2) + "\n")
